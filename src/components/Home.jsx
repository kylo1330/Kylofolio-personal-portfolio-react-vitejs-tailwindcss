...
const Home = () => {
    const work = ['Frontend Development', 2000, 'Backend Development', 2000, 'Full Stack ', 2000, 'Web Designing', 2000];
        ...
        <div name='Home' className='pt-8 h-full min-h-screen w-full flex items-center bg-gradient-to-b from-black via-black to-gray-800'>
            <div className='section gap-16 md:gap-1 md:justify-between items-center md:flex-row-reverse'>
                <div className='flex flex-col justify-center md:w-2/5 max-w-[320px]'>
                    <img src="https://w0.peakpx.com/wallpaper/630/87/HD-wallpaper-kylo-ren-dark-side-first-order-sith-sith-lord-star-wars-star-wars-episode-8-star-wars-episode-9-starwars-the-rise-of-skywalker.jpg" alt="Avatar" width="auto" height="auto" loading='eager' title='Avatar' className='rounded-full mx-auto w-full' />
                </div>
                <div className='pl-2 xs:pl-8 flex flex-col gap-3 justify-center text-gray-200 w-max md:w-3/5'>
                    <h1 className='text-5xl xs:text-6xl lg:text-7xl font-bold '>
                        ...
                        <span>I'm </span>
                        <span className='text-transparent bg-gradient-to-br from-cyan-300 to-blue-600 bg-clip-text'> Alan </span>
                    </h1>
