...
import { GMail, Map, CopyRight, ArrowRightLong, Call } from './Icons';
import { Link } from 'react-scroll';
import navLinks from '../data/navlinks'; // Corrected import statement
import contactInfo from '../data/contactInfo';

const Footer = () => {
    const year = new Date().getFullYear().toString();
    return (
        <div className='bg-gradient-to-t from-gray-800 via-black to-black  w-full  text-gray-300'>
            <div className="section pb-5">
                <div className="flex flex-wrap justify-between ">
                    <div className="w-full sm:w-3/5 lg:w-2/5 pr-2">
                        <h3 className='text-white text-[1.75rem] font-bold pb-2'>Alan Johnson</h3>
                        <p className='text-lg text-cyan-400 pb-5'>FullStack Developer</p>
                        <p>Thank you for visiting KyloFolio.</p>
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
                            <div className='text-[0.9rem] font-advanced'>
                                <p className='flex items-center gap-3 mb-1'>
                                    <GMail /> alanjohnsoncoc@gmail.com
                                </p>
                                <p className='flex items-center gap-3'>
                                    <Map /><span className="pt-1">Trivandrum, Kerala, India</span>
                                </p>
                                <p className='flex items-center gap-3'>
                                    <Call /> 7306599931
                                </p>
            ...
            <div className="section py-2 text-black font-advanced">
                <div className="">
                    <p className='text-sm text-gray-300 flex justify-center items-center'>
                        <span className="px-1 pb-[0.2rem]"><CopyRight /></span> {`2023- ${year}`} | All Rights Reserved
                    </p>
                </div>
            </div>
        </div>
